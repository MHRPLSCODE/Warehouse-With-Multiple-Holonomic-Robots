...
class HolonomicController(Node):
    def __init__(self):
        super().__init__('holonomic2_controller')
        ...
        # ---------------- PID ----------------     # UNIQUE TO BOT
        self.pid_x = PID(6.0, 0.0, 0.8, 45.0)
        self.pid_y = PID(6.0, 0.0, 0.8, 45.0)


        # ---------------- arm angles ----------------     # UNIQUE TO BOT
        self.default_elbow = 0.0
        self.pickup_elbow = 0.0
        self.default_base = 25.0
        self.drop_base =  25.0
        self.rotate_base = 25.0
        self.stack_lift_base = 60.0
        self.stack_lift_elbow = 0.0
        self.stack_drop_base = 50.0
        self.stack_drop_elbow = 0.0
        self.pbase = None
        self.pelbow = None
        ...
        self.STOP_RADIUS = 40.0
        self.BRAKE_RADIUS = 300.0   # start slowing down here

        self.pickup_start_time = None
        self.PICKUP_DELAY = 20.0  # seconds (tune this)
        ...
        self.state_ir = True
        self.prev_ir = True
        self.create_subscription(Bool, '/bot2/ir', self.ir_cb, 10)      #UNIQUE TO BOT
